...
node('node'){
   ...
   stage('test case and report'){
      try {
         ...
         publishHTML([allowMissing: false, alwaysLinkToLastBuild: false, keepAll: false, reportDir: 'htmlreports/SureFireReportHTML', reportFiles: 'htmlpublisher-wrapper.html', reportName: 'SureFireReportHTML', reportTitles: ''])
